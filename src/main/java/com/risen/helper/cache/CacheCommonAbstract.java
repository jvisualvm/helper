 ...
 */
@Deprecated
public abstract class CacheCommonAbstract<K, V> implements Serializable {

    private Integer expire = 4;
    private Integer maximumSize = 100000;
    private Integer initialCapacity = 1024;
    private static List<CacheCommonAbstract> implTree = new ArrayList<>();

    public LoadingCache<K, V> cache;

    public abstract V getOneByKey(K k);

    public abstract void loadAll();

    public CacheCommonAbstract(Integer expire, Integer maximumSize, Integer initialCapacity) {
        implTree.add(this);
    ...
    public static List<CacheCommonAbstract> getImplTree() {
        return implTree;
    }
}
