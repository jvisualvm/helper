 ...
 */
public abstract class CacheDataAbstract<K, V, L> implements Serializable {

    private Long expire = 4L;
    private Integer maximumSize = 100000;
    private Integer initialCapacity = 1024;

    private static List<CacheDataAbstract> implTree = new ArrayList<>();
    ...
    public CacheDataAbstract(Long expire, Integer maximumSize, Integer initialCapacity) {
        implTree.add(this);
    ...
    public static List<CacheDataAbstract> getImplTree() {
        return implTree;
    }
}
