 ...
 */
@ConditionalOnProperty(prefix = "spring.datasource.dynamic.datasource", name = "dict.url")
@Configuration
@MapperScan(basePackages = "com.risen.helper.translate.mapper", sqlSessionTemplateRef = "dict")
public class MybatisPlusDictConfig {


    /**********************************************************dict配置************************************************/
    @ConfigurationProperties(prefix = "spring.datasource.dynamic.datasource.dict")
    ...
    public DataSource dictDataSource(@Qualifier("dictDataSourceProperties") DataSourceProperties dataSourceProperties) {
